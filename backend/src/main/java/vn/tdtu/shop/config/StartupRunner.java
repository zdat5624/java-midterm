...
public class StartupRunner implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        // // Khởi tạo dữ liệu thương hiệu
        // System.out.println(">>> KHỞI TẠO BẢNG 'brands': 12 THƯƠNG HIỆU");
        ...
        // System.out.println(">>> KHỞI TẠO DỮ LIỆU THƯƠNG HIỆU THÀNH CÔNG");
        // } else {
        // System.out.println(">>> BỎ QUA KHỞI TẠO THƯƠNG HIỆU: BẢNG 'brands' ĐÃ CÓ DỮ
        // LIỆU");
        // }

        // // Khởi tạo dữ liệu danh mục
        // System.out.println(">>> KHỞI TẠO BẢNG 'categories': 5 DANH MỤC");
        // if (categoryRepository.count() == 0) {
        // List<Category> categoryList = new ArrayList<>();
        // String[] categoryNames = {
        // "Doanh nhân", "Gaming - Đồ họa", "Mỏng nhẹ", "Sinh viên - Văn phòng", "AI"
        // };
        ...
        // System.out.println(">>> KHỞI TẠO DỮ LIỆU DANH MỤC THÀNH CÔNG");
        // } else {
        // System.out.println(">>> BỎ QUA KHỞI TẠO DANH MỤC: BẢNG 'categories' ĐÃ CÓ DỮ
        // LIỆU");
        // }
        ...
        // product.setPrice(BigDecimal.valueOf(100 + random.nextInt(900))); // Giá từ
        // 100 đến 999
        ...
        // product.setSoldQuantity((long) random.nextInt(100)); // Số lượng bán ngẫu
        // nhiên
        ...
        // detailedDescription.append("Mô tả chi tiết cho sản phẩm
        // ").append(i).append(":\n");
        // int sentenceCount = random.nextInt(3) + 5; // 3-5 câu
        // for (int j = 0; j < sentenceCount; j++) {
        // String sentence =
        // descriptionSentences[random.nextInt(descriptionSentences.length)];
